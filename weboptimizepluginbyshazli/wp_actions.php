	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, '5ad8737ad9b71764eaee3fa053ea86ce', '90ce463dee93a62bad50f1105bc22d9e');
		ALAccount::updateApiPublicKey($this->settings, '5ad8737ad9b71764eaee3fa053ea86ce');
			}
